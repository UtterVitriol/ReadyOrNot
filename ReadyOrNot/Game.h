...
public:
	...
	uintptr_t m_LocalPlayerFirstOffset = 0x05968760;
...
#define DERR(s) g_Game.log.AddLog("[-]: %s:%d:%s(): %s\n", __FILENAME__, __LINE__, __func__, s)
#define DMSG(s) g_Game.log.AddLog("[+]: %s:%d:%s(): %s\n", __FILENAME__, __LINE__, __func__, s)
#define DMSGP(s) g_Game.log.AddLog("[+]: %s:%d:%s(): %p\n", __FILENAME__, __LINE__, __func__, s)
#define DMSGD(s) g_Game.log.AddLog("[+]: %s:%d:%s(): %d\n", __FILENAME__, __LINE__, __func__, s)
#define DMSGF(s) g_Game.log.AddLog("[+]: %s:%d:%s(): %f\n", __FILENAME__, __LINE__, __func__, s)